...
using System.Text;
/// <summary>
/// https://kunuk.wordpress.com/2012/01/14/q-learning-library-example-with-csharp/
/// </summary>
namespace QLearningFramework
{
    ...
    /// one to many relati  onships data structure
    /// QLearning [1 -- *] State [1 -- *] Action [1 -- *] ActionResult
    /// </summary>
    public class QLearning
    {
        public List<QState> States { get;  set; }
        public Dictionary<string, QState> StateLookup { get;  set; }

        public double Alpha { get;  set; }
        public double Gamma { get;  set; }

        public HashSet<string> EndStates { get;  set; }
        public int MaxExploreStepsWithinOneEpisode { get;  set; } //avoid infinite loop
        public bool ShowWarning { get;  set; } // show runtime warnings regarding q-learning
    ...
    public class QActionResult
    {
        public string StateName { get;  set; }
        public string PrevStateName { get;  set; }
        public double QValue { get;  set; } // Q value is stored here        
